...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'currentPage',
          path: '/currentPage',
          builder: (context, params) => const CurrentPageWidget(),
        ),
        FFRoute(
          name: 'Aboutus',
          path: '/aboutus',
        ...
        FFRoute(
          name: 'currentPageCopy',
          path: '/currentPageCopy',
          builder: (context, params) => const CurrentPageCopyWidget(),
        ),
        FFRoute(
          name: 'reservation',
          path: '/reservation',
        ...
        FFRoute(
          ...
          builder: (context, params) => const ReservationCopyWidget(),
        ),
        FFRoute(
          name: 'Profile',
          path: '/profile',
        ...
        FFRoute(
          name: 'currentPageCopyCopy',
          path: '/currentPageCopyCopy',
          builder: (context, params) => const CurrentPageCopyCopyWidget(),
        )
