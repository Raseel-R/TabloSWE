        ...
        body: SafeArea(
          ...
          child: Stack(
            children: [
              ...
              Align(
                alignment: const AlignmentDirectional(-0.06, -0.5),
                child: Icon(
              ...
              Align(
                alignment: const AlignmentDirectional(-0.05, -0.11),
                child: Text(
                  'Sarah',
              ...
              Align(
                alignment: const AlignmentDirectional(0.43, -0.09),
                child: Icon(
                  Icons.edit,
                  color: FlutterFlowTheme.of(context).secondaryText,
                  size: 29.0,
              ...
              Align(
                alignment: const AlignmentDirectional(0.42, 0.58),
                child: Icon(
                  Icons.logout,
                  color: FlutterFlowTheme.of(context).secondaryText,
                  size: 25.0,
              ...
              Align(
                alignment: const AlignmentDirectional(0.4, 0.57),
                child: FaIcon(
